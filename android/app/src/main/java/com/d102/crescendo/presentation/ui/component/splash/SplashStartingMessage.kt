package com.d102.crescendo.presentation.ui.component.splash
...
@Composable
fun SplashStartingMessage(
    modifier: Modifier = Modifier,
    // 커스터마이즈 포인트
    title: String = "Crescendo에 오신 걸 환영해요!"
) {
    Column(
        modifier = modifier,
...
private fun BouncingDotsRow() {
    Row(
        ...
        BouncingDot(delayMillis = 120)
        BouncingDot(delayMillis = 240)
    }
}
